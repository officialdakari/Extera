...
export const getHomeThreadPath = (roomIdOrAlias: string, threadId: string, eventId?: string): string => {
    const params = {
        roomIdOrAlias: encodeURIComponent(roomIdOrAlias),
    ...
    return generatePath(HOME_THREAD_PATH, params);
};
...
export const getDirectThreadPath = (roomIdOrAlias: string, threadId: string, eventId?: string): string => {
    const params = {
        roomIdOrAlias: encodeURIComponent(roomIdOrAlias),
        eventId: eventId ? encodeURIComponent(eventId) : null,
        threadId: encodeURIComponent(threadId)
    ...
    return generatePath(DIRECT_THREAD_PATH, params);
};
...
export const getSpaceThreadPath = (
    spaceIdOrAlias: string,
    roomIdOrAlias: string,
    threadId: string,
    eventId?: string,
    ...
    return generatePath(SPACE_THREAD_PATH, params);
};
