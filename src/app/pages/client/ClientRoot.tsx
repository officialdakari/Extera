...
import { Box, Button, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Typography } from 'react-you-ui';
...
function ClientRootLoading() {
	return (
		<SplashScreen>
			<Box display='flex' flexDirection="column" flexGrow={1} alignItems="center" justifyContent="center" gap="16px">
				<CircularProgress />
				<Typography>
					{getText('loading')}
				</Typography>
		...
		<SpecVersions baseUrl={baseUrl!}>
			{loading ? (
				...
				<Dialog open onClose={(e) => e.preventDefault()}>
					...
					<DialogActions>
						<Button variant='filled-tonal' onClick={() => initMatrix.clearCacheAndReload()}>Clear cache</Button>
