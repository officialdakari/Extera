...
import { mdiPlus, mdiServerNetwork, mdiServerNetworkOutline, mdiStar, mdiStarOutline } from '@mdi/js';
		...
		>
			<PageNavContent>
				<Box direction="Column" gap="300">
					<NavCategory>
						<NavItem style={{ background: 'transparent' }} aria-selected={featuredSelected}>
