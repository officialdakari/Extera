...
// type MarkButtonProps = { format: MarkType; icon: IconSrc; tooltip: ReactNode, quill: React.RefObject<ReactQuill> };
// export function MarkButton({ format, icon, tooltip, quill }: MarkButtonProps) {
//     const disableInline = isBlockActive(quill, BlockType.CodeBlock);
...
//                     onClick={handleClick}
//                     aria-pressed={isMarkActive(quill, format)}
//                     size="400"
//                     radii="300"
...
// type ExitFormattingProps = { tooltip: ReactNode, quill: React.RefObject<ReactQuill> };
// export function ExitFormatting({ tooltip, quill }: ExitFormattingProps) {
//     const handleClick = () => {
//         if (isAnyMarkActive(quill)) {
//             removeAllMark(quill);
//         } else if (!isBlockActive(quill, BlockType.Paragraph)) {
//             toggleBlock(quill, BlockType.Paragraph);
//         }
//     };
...
// type ToolbarProps = { quill: React.RefObject<ReactQuill> };
// export function Toolbar({ quill }: ToolbarProps) {
...
//                                     size="300"
//                                     radii="300"
//                                     disabled={disableInline || !!isAnyMarkActive(quill)}
//                                 >
